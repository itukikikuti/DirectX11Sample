...
public:
    ...
    void CreateTriangle(bool shouldClear = true)
    {
        ...
        vertices.push_back({ Float3(0.0f, 1.0f, 0.0f), Float3(0.0f, 0.0f, -1.0f), Float2(0.5f, 0.0f) });
        vertices.push_back({ Float3(1.0f, -1.0f, 0.0f), Float3(0.0f, 0.0f, -1.0f), Float2(1.0f, 1.0f) });
